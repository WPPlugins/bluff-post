...
<div class="container">
	<div class="page-header">
		<h1><?php esc_html_e( 'Registration recipients', 'bluff-post' ) ?></h1>
	</div>
	...
	<?php wp_nonce_field( 'blfpst-target-option', 'blfpst_target_option' ); ?>
		...
		<div class="row outer_block" id="title_container" style="padding-bottom: 24px;">
			<div class="form-horizontal">
				<div class="form-group">
					<label for="title" class="col-sm-2 control-label text-right"><?php esc_html_e( 'Recipients name', 'bluff-post' ) ?></label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label for="class_name" class="col-sm-2 control-label text-right"><?php esc_html_e( 'DB', 'bluff-post' ) ?></label>
					<div class="col-sm-8">
		...
		<?php for (
			...
			<?php if ( 0 < $i ) : ?>
				<select name="and_or<?php echo $i ?>" title="and or">
			...
			<div class="panel panel-default" id="group<?php echo $i ?>">
				<div class="panel-heading">
					...
					<?php if ( 0 < $i ) : ?>
						<a href="javascript:void(0)" onclick="deleteGroup(<?php echo( $i ) ?>)" id="delete<?php echo( $i ) ?>"><i class="fa fa-minus-circle" aria-hidden="true"></i></a>
					<?php endif ?>
				</div>
					...
					<?php for ( $j = 0; $j < count( $target_conditionals ); $j ++ ) : ?>
						...
						<div id="group<?php echo $param ?>" class="target_condition_line">
							<div class="form-inline">
								...
								<?php if ( 0 < $j ) : ?>
									<a href="javascript:void(0)" onclick="deleteConditional(<?php echo esc_attr( $i ) ?>, <?php echo esc_attr( $j ) ?>)" id="delete<?php echo $param ?>"><i class="fa fa-minus-circle" aria-hidden="true"></i></a>
								<?php endif ?>
						...
						<?php if ( ( count( $target_conditionals ) - 1 ) == $j ) : ?>
							<button type="button" class="btn btn-default btn-xs"
							        ...
							        onclick="addConditional(<?php echo $i ?>)"><span
		...
		<div class="row" style="margin-top: 8px;">
			<div class="col-sm-6">
				<button type="button" class="btn btn-default" onclick="addGroup()"><?php esc_html_e( 'Add group', 'bluff-post' ) ?></button>
			</div>
			<div class="col-sm-6 text-right">
				<button type="button" class="btn btn-default" id="recipientsPreviewButton" onclick="onRecipientsPreviewButton(0, <?php echo esc_html( $default_recipient_per_page ) ?>)">
					<?php esc_html_e( 'Preview recipients', 'bluff-post' ) ?>
				</button>
				<button type="button" class="btn btn-default" id="sqlPreviewButton" onclick="requestPreviewSQL()"><?php esc_html_e( 'Preview SQL', 'bluff-post' ) ?></button>
	...
	<div class="panel panel-default" style="margin-top: 32px;" id="sql_preview_box">
		<div class="panel-body">
		...
		<div class="col-sm-10 col-sm-offset-1">
			<div class="outer_block">
				...
				<div id="recipient_loading_message" style="display: none">
					<span class="glyphicon glyphicon-refresh" aria-hidden="true"></span><?php esc_html_e( 'Loading....', 'bluff-post' ) ?>
				</div>
			</div>
