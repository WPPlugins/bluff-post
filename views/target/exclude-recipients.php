...
<div class="container">
	<div class="page-header">
		<h1><?php esc_html_e( 'Exclusion recipients', 'bluff-post' ) ?></h1>
	</div>
	...
	<div class="row outer_block" style="margin-bottom: 32px;">
			<div class="col-sm-6 col-sm-offset-1" id="exclude_address_container">
		...
		<div class="col-sm-8 col-sm-offset-1">
			<?php if ( 0 < count( $exclude_recipients ) ) : ?>
				<div class="panel panel-default">
					<div class="panel-heading"><?php esc_html_e( 'Exclusion recipients', 'bluff-post' ) ?></div>
						...
						<table class="table">
							...
							<?php foreach ( $exclude_recipients as $exclude_recipient ) : ?>
								...
								<tr>
									...
									<td style="width: 32px;">
										<a href="<?php echo esc_url( $delete_url ) ?>"><i class="fa fa-times" aria-hidden="true"></i></a>
									</td>
								</tr>
							<?php endforeach ?>
						</table>
