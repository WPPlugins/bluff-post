...
<script type="text/javascript">
	...
	function notify_sending_status(send_mail_id,
		...
		if (isFinish) {
			...
			var send_request_datetime = '<i class="fa fa-hourglass-half" aria-hidden="true"></i> ' + send_request_start_at + ' 〜 ' + send_request_end_at;
...
<div class="container">
	<div class="page-header">
		...
		<div class="row">
			<div class="col-sm-6">
				<span class="glyphicon glyphicon-stats" aria-hidden="true"></span> <?php esc_html_e( 'It just have a transmission request.', 'bluff-post' ) ?>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6">
	...
	<div class="row outer_block">
		<div class="col-sm-8 col-sm-offset-2">
			<div class="col-sm-4 text-center">
				<div><i class="fa fa-child fa-5x" aria-hidden="true"></i></div>
			...
			<div class="col-sm-4 text-center">
				<div><i class="fa fa-motorcycle fa-5x" aria-hidden="true"></i></div>
				<div style="font-size: 32px;">
					<span id="success_count"><?php echo esc_html( number_format( $success_count ) ) ?></span></div>
			</div>
			<div class="col-sm-4 text-center">
				<div><i class="fa fa-minus-circle fa-5x" aria-hidden="true"></i></div>
				<div style="font-size: 32px;">
					<span id="failure_count"><?php echo esc_html( number_format( $failure_count ) ) ?></span></div>
			</div>
		</div>
	</div>
	...
	<div class="row outer_block">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row" id="response_message_box" style="display: <?php echo $response_message_box_display ?>">
