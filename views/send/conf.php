...
<div class="container">
	...
	<div class="row outer_block" style="padding-bottom: 26px;">
	...
	<form method="post" class="form-horizontal">
		...
		<div class="row">
			<div class="col-sm-6">
				<button type="button" onclick="history.back()" class="btn btn-default"><?php esc_attr_e( 'Back', 'bluff-post' ) ?></button>
			</div>
			<div class="col-sm-6 text-right">
				<?php if ( ! $is_reserved ) : ?>
					<button type="submit" class="btn btn-primary"><?php esc_html_e( 'To start transmission', 'bluff-post' ) ?></button>
				<?php else : ?>
					<?php if ( $is_edit ) : ?>
