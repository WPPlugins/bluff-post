...
<div class="container">
	<div class="page-header">
		<h1><?php esc_html_e( 'Logs', 'bluff-post' ) ?></h1>
	</div>
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading"><?php esc_html_e( 'Operation log', 'bluff-post' ) ?></div>
						...
						<table class="table">
							...
							<?php foreach ( $logs as $log ) : ?>
								...
								<tr>
									...
									<td>
										<a href="<?php echo esc_url( $delete_url ) ?>" role="button"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></a>
									</td>
								</tr>
							<?php endforeach ?>
						</table>
