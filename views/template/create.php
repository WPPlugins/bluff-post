...
<div class="container">
	<div class="page-header">
		<h1><?php esc_html_e( 'Registration template', 'bluff-post' ) ?></h1>
	</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="row">
					<div class="form-group">
						<label for="title" class="col-sm-2 control-label"><?php esc_html_e( 'Template name', 'bluff-post' ) ?></label>
						<div class="col-sm-6" id="title_container">
							...
							/>
							<i class="form-control-feedback blfpst-icon-no-label glyphicon" data-blfpst-icon-for="title"></i>
						</div>
					</div>
				</div>
			</div>
			<div class="panel-body">
				...
				<div class="row" style="padding-bottom: 10px;">
					<div class="col-sm-2 text-right"><strong><?php esc_html_e( 'Form', 'bluff-post' ) ?></strong></div>
					<div class="col-sm-6">
				...
				<div class="row" style="padding-bottom: 10px;">
					<div class="col-sm-2 text-right"><strong><?php esc_html_e( 'From address', 'bluff-post' ) ?></strong></div>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label for="reply_address" class="col-sm-2 control-label"><?php esc_html_e( 'Replay', 'bluff-post' ) ?></label>
				...
				<div class="form-group">
					<label for="subject" class="col-sm-2 control-label"><?php esc_html_e( 'Subject', 'bluff-post' ) ?></label>
					...
					<div class="col-sm-8 col-sm-offset-2">
						<div class="btn-group" data-toggle="buttons">
							<label class="btn btn-default <?php echo ! $is_text_mail ? 'active' : '' ?>" id="content_type_html_label">
								<input type="radio" name="content_type" id="content_type_html" value="content_type_html" autocomplete="off" <?php echo ! $is_text_mail ? 'checked' : '' ?>> <?php esc_attr_e( 'HTML mail', 'bluff-post' ) ?>
							</label>
							<label class="btn btn-default <?php echo $is_text_mail ? 'active' : '' ?>" id="content_type_text_label">
								<input type="radio" name="content_type" id="content_type_text" value="content_type_text" autocomplete="off" <?php echo $is_text_mail ? 'checked' : '' ?>> <?php esc_attr_e( 'Text mail', 'bluff-post' ) ?>
							</label>
						</div>
					</div>
