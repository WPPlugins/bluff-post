            ...
            if (calendarObj instanceof Array) {
                ...
                for (var $i = 0; $i < calendarObj.length; $i++) {
                    ...
                    if ('true' === is_future) {
                        ...
                        $anchor.append('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>');
                    }
                    ...
                    if (sendData.length > 0) {
                        ...
                        for (var $j = 0; $j < sendData.length; $j++) {
                            ...
                            var link = '';
                            if (reserved_time === '') {
                                $li.append('<span class="badge">' + target_count + '</span>');
                            } else {
                                link = '<span class="label label-info">' + reserved_time + '</span>';
                            }
