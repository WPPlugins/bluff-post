...
class BLFPST_Script_Controller {
	...
	public function include_admin_scripts_styles( $hook_suffix ) {
		...
		if ( preg_match( '/blfpst-/', $hook_suffix ) ) {
			...
			wp_register_style( 'blfpst_bootstrap_styles', plugins_url( 'vendor/bootstrap/css/bootstrap.min.css', dirname( __FILE__ ) ) );
			wp_register_style( 'blfpst_bootstrap_styles', plugins_url( 'vendor/bootstrap/css/bootstrap-modal.css', dirname( __FILE__ ) ) );
			wp_enqueue_style( 'blfpst_bootstrap_styles' );

			wp_register_script( 'blfpst_bootstrap_js', plugins_url( 'vendor/bootstrap/js/bootstrap.min.js', dirname( __FILE__ ) ), array( 'jquery' ) );
			wp_enqueue_script( 'blfpst_bootstrap_js' );

			wp_register_style( 'font-awesome', plugins_url( 'vendor/font-awesome/css/font-awesome.min.css', dirname( __FILE__ ) ) );
